...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  //         _buildNavBarItem(Icons.local_mall_outlined, 'SHOP', isSelected: false),
  //         _buildNavBarItem(Icons.emoji_events_outlined, 'REWARDS', isSelected: false),
  //         _buildNavBarItem(Icons.explore_outlined, 'QUESTS', isSelected: false),
  //         _buildNavBarItem(Icons.people_outline_rounded, 'SOCIAL', isSelected: true),
  //       ],
  //     ),
  //   );
  // }
  ...
  //   final color = isSelected ? const Color(0xFF64748B) : const Color(0xFFCBD5E1);
  //   return Column(
